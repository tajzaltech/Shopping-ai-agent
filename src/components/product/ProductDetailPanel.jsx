...
const ProductDetailPanel = ({ product, isOpen, onClose }) => {
    ...
    const displayImage = imageUrl || image || 'https://images.unsplash.com/photo-1591047139829-d91aecb6caea?auto=format&fit=crop&q=80&w=400';
            ...
            >
                ...
                <div className="flex items-center justify-between p-6 border-b border-grey-100 bg-white sticky top-0 z-10">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-grey-400 uppercase tracking-widest mt-1">Ref: {brand.slice(0, 3)}-{product.id}</p>
                        </div>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-8 scrollbar-thin scrollbar-thumb-grey-200">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-start justify-between">
                            <div>
                                <span className="text-xs font-black text-navy-600 uppercase tracking-[0.2em]">{brand}</span>
                                <h3 className="text-2xl font-black text-navy-900 mt-1">{name}</h3>
                            </div>
                        ...
                        <div className="flex items-baseline gap-3">
                            <span className="text-3xl font-black text-navy-900">Rs. {price.toLocaleString()}</span>
                            {originalPrice > 0 && (
                                <span className="text-sm text-grey-300 line-through font-bold">Rs. {originalPrice.toLocaleString()}</span>
                            )}
                        </div>
                    </div>
                    ...
                    <div className="bg-navy-50 rounded-3xl p-6 border border-navy-100">
                        ...
                        <p className="text-sm text-navy-700 leading-relaxed font-medium">
                            "This piece perfectly captures your <span className="text-navy-900 font-bold">{vibe}</span> preference. The {brand} silhouette is optimized for a modern yet traditional look, making it a high-confidence match ({vibeMatch}%) for your style profile."
                        </p>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-sm text-grey-600 leading-relaxed">
                            Crafted from premium fabric, this {name} from {brand} features intricate detailing that stands out. Designed for both comfort and elegance, it's a versatile choice for your formal or casual festive wardrobe.
                        </p>
                ...
                <div className="p-6 border-t border-grey-100 bg-white">
                    ...
                    <button
                        ...
                        className="w-full py-4 bg-white border-2 border-grey-200 rounded-2xl font-black text-navy-900 text-sm flex items-center justify-center gap-3 hover:border-navy-900 hover:bg-navy-50 transition-all"
                    >
