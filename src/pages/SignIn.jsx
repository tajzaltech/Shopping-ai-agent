            ...
            <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-navy-800 via-navy-900 to-black relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col justify-center items-center w-full p-12 text-white">
                    ...
                    <p className="text-lg text-white/70 text-center max-w-md">
                        Your personal AI stylist is ready to help you find the perfect outfit for any occasion.
                    </p>
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="bg-white rounded-3xl shadow-xl border border-grey-200 p-8">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-grey-600">Continue your style journey</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div className="flex items-center justify-between text-sm">
                                <label className="flex items-center gap-2 cursor-pointer">
                                    <input type="checkbox" className="w-4 h-4 rounded border-grey-300 text-navy-600 focus:ring-navy-500" />
                                    <span className="text-grey-600">Remember me</span>
                                </label>
                                <a href="#" className="text-navy-600 hover:text-navy-800 font-medium">Forgot password?</a>
                            </div>
                        ...
                        <div className="mt-8 text-center">
                            <p className="text-grey-600">
                                ...
                                <Link to="/signup" className="text-navy-600 hover:text-navy-800 font-semibold">
                                    Sign up free
                                </Link>
                            </p>
                        </div>
