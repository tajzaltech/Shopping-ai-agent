            ...
            <div className="w-full max-w-xl">
                ...
                <div className="flex flex-col items-center mb-10 text-center space-y-4">
                    ...
                    <div className="space-y-1">
                        <h2 className="text-3xl font-black text-navy-900 tracking-tight leading-none">Create Account</h2>
                        <p className="text-grey-500 font-medium">Start your personalized style journey today</p>
                    </div>
                </div>
