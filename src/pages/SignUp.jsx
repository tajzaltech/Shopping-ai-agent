            ...
            <div className="w-full max-w-xl">
                ...
                <div className="flex flex-col items-center mb-6 md:mb-10 text-center space-y-3 md:space-y-4">
                    ...
                    <div className="space-y-1">
                        <h2 className="text-2xl md:text-3xl font-black text-navy-900 tracking-tight leading-none">Create Account</h2>
                        <p className="text-sm md:text-base text-grey-500 font-medium">Start your personalized style journey today</p>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-[2rem] md:rounded-[2.5rem] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] border border-grey-100 p-6 sm:p-10 md:p-12">
                    ...
                    <div className="relative mb-8">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-4 bg-white text-grey-400 font-bold uppercase tracking-widest text-[10px]">or sign up with email</span>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="grid md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <label className="text-xs font-black text-navy-900 uppercase tracking-widest ml-1">Full Name</label>
                                <div className="relative group">
                                    <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-grey-400 group-focus-within:text-navy-900 transition-colors" />
                                    <input
                                        type="text"
                                        value={name}
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-black text-navy-900 uppercase tracking-widest ml-1">Password</label>
                            <div className="relative group">
                        ...
                        <div className="flex items-start gap-3 p-1">
                            <input type="checkbox" className="w-5 h-5 mt-0.5 rounded-lg border-grey-300 text-navy-900 focus:ring-navy-500 cursor-pointer" required />
                            <span className="text-sm text-grey-500 font-medium leading-relaxed">
                                I agree to the <a href="#" className="text-navy-900 font-bold hover:underline">Terms of Service</a> and acknowledge the <a href="#" className="text-navy-900 font-bold hover:underline">Privacy Policy</a>
                            </span>
                        </div>
                    ...
                    <div className="mt-10 pt-8 border-t border-grey-50 text-center">
                        <p className="text-grey-500 font-medium">
                            ...
                            <Link to="/signin" className="text-navy-900 font-black hover:text-black transition-colors">
                                Sign in here
                            </Link>
                        </p>
                    </div>
